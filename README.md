...
Backend mínimo em FastAPI para o plugin Speed Run de Complexidade. Este repositório atende aos requisitos da Fase 1 (início e preparação).
...
Navegador: abra http://127.0.0.1:8000/health
cURL:
...
Feature branches: feature/<nome> (ex.: feature/score-calculator).
Comandos iniciais
git init
git add .
